...
export const Hero = () => {
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[100px] opacity-40 pointer-events-none" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                <motion.div
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full glassmorphism border-blue-500/30 text-blue-400 text-sm font-medium mb-8"
                ...
                <motion.h1
                    ...
                    animate="visible"
                >
                    <motion.span variants={fadeInUp} className="block">Decentralized Routing</motion.span>
                    <motion.span variants={fadeInUp} className="block gradient-text mt-2">For Global Payments</motion.span>
                </motion.h1>
                ...
                >
                    Instant, secure, zero-fee global payments across Africa. Connect developers, businesses, and liquidity providers seamlessly.
                </motion.p>
                ...
                >
                    {[
                        { icon: <Zap className="w-6 h-6 text-blue-400" />, title: "Instant Settlement", desc: "Transactions clear in seconds, not days." },
                        { icon: <Shield className="w-6 h-6 text-purple-400" />, title: "Secure Routing", desc: "Encrypted data & transparent ledgers." },
                        { icon: <Globe className="w-6 h-6 text-emerald-400" />, title: "Global Reach", desc: "Support for multiple African fiat currencies." }
                    ].map((feature, i) => (
                        <motion.div
                            key={i}
                            variants={fadeInUp}
